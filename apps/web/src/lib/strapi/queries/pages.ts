...
const PAGE_POPULATE = {
  ...
  'populate[body][on][blocks.blob-hero][populate][image]': '*',
  'populate[body][on][blocks.blob-hero][populate][primary][populate]': 'page',
  'populate[body][on][blocks.blob-hero][populate][secondary][populate]': 'page',
  ...
  'populate[body][on][blocks.persona-cards][populate][cards]': '*',
